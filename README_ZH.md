...
## 本项目已捐赠给 Apache Camel。
## 组件 [camel-rocketmq](https://search.maven.org/artifact/org.apache.camel/camel-rocketmq) 已由 Apache Camel 官方发布！ 
...
源码地址：https://github.com/apache/camel/tree/main/components/camel-rocketmq
